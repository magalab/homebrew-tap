cask "idev" do
  ...
  on_arm do
    sha256 "sha256:4aec412073b9fcc5c8d3013d79c09f06c09a54d848a9b99ad9652689b0e9312e"
    url "https://github.com/magalab/idev/releases/download/v#{version}/idev-v#{version}-arm64.dmg"
  end

  on_intel do
    sha256 "sha256:e4c7b9f68eaee21cfcd2e57fd9e626a08b5e55f5e1cd671f66f352e3e5fd68d0"
